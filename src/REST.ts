 ...
 */
export type RateLimitQueueFilter = (
...
export class REST extends EventEmitter {
  ...
  public constructor(options: Partial<RESTOptions> = {}) {
    ...
    this.requestManager = new RequestManager(options)
      ...
      .on(
        RESTEvents.InvalidRequestWarning,
        this.emit.bind(this, RESTEvents.InvalidRequestWarning)
      )
      .on(RESTEvents.HashSweep, this.emit.bind(this, RESTEvents.HashSweep));

    this.on("newListener", (name, listener) => {
      if (name === RESTEvents.Request || name === RESTEvents.Response)
